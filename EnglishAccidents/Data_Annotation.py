...
def add_box1(value):
    ...
    if lastoptionsmenuval == '':
        ...
        if (value == 'ambulanceCalled') or (value == 'firemenInvolved') or (value == 'hasDied') or (
                value == 'hasDied1') or (value == 'hasDied2') or (value == 'hasDied3') or (
                value == 'helicopterCalled') or (value == 'isUnilateral') or (
                value == 'reanimationAttempted') or (value == 'takenToHospital') or (value == 'personnelCalled'):
...
def save_all():
    ...
    with zipfile.ZipFile(currentpath + '/Corpus/' + zipfilenames[allindices[-1][0]]) as z:
